...
import 'package:ecommerce_app_firebase/views/screens/chat_screen.dart';
...
import 'package:ecommerce_app_firebase/views/screens/users_chat_list_screen.dart';
      ...
      builder: (context, child) {
        return GetMaterialApp(
          ...
          routes: {
            ...
            'UserChatListScreen': (context) => UserChatListScreen(),
